...
class PagoAbono extends Model
{
    ...
    // Bug real (10/09/2026): sin esto, Eloquent adivina 'pago_abonos'
    // (orden literal de las palabras de la clase) — la tabla real de la
    // migración es 'pagos_abonos' (con la 's' de plural corrida). Mismo
    // problema que Reservacion — ver ese modelo.
